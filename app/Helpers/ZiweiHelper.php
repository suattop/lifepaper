...
class ZiweiHelper
{
    ...
    public static function current_decade(Destiny $destiny)
    {
        ...
        for ($i = 0; $i <= 11; $i++) {
            ...
            if ($current_decade->end_age >= $current_age) {
                break;
            }
        }
    ...
    {
        $palaces = ['命宮', '父母宮', '福德宮', '田宅宮', '事業宮', '交友宮', '遷移宮', '疾厄宮', '財帛宮', '子女宮', '夫妻宮', '兄弟宮'];
        $result = DB::table('ziweis')->where('destiny_id', $destiny['id'])->get();
        for ($i = 0; $i <= 11; $i++) {
            if ($result[$i]->branch == $new_life_branch) {
                break;
            }
        }
        $new_no = $i;
    ...
    public static function squarePalace($palace)
    {
        switch($palace) {
            case '命宮':
                $result = ['命宮', '遷移宮', '事業宮', '財帛宮'];
                break;
            case '父母宮':
                $result = ['父母宮', '疾厄宮', '交友宮', '子女宮'];
                break;
            case '福德宮':
                $result = ['福德宮', '財帛宮', '遷移宮', '夫妻宮'];
                break;
            case '田宅宮':
                $result = ['田宅宮', '子女宮', '疾厄宮', '兄弟宮'];
                break;
            case '事業宮':
                $result = ['事業宮', '夫妻宮', '財帛宮', '命宮'];
                break;
            case '交友宮':
                $result = ['交友宮', '兄弟宮', '子女宮', '父母宮'];
                break;
            case '遷移宮':
                $result = ['遷移宮', '命宮', '福德宮', '夫妻宮'];
                break;
            case '疾厄宮':
                $result = ['疾厄宮', '父母宮', '兄弟宮', '田宅宮'];
                break;
            case '財帛宮':
                $result = ['財帛宮', '福德宮', '命宮', '事業宮'];
                break;
            case '子女宮':
                $result = ['子女宮', '田宅宮', '父母宮', '交友宮'];
                break;
            case '夫妻宮':
                $result = ['夫妻宮', '事業宮', '福德宮', '遷移宮'];
                break;
            case '兄弟宮':
                $result = ['兄弟宮', '交友宮', '田宅宮', '疾厄宮'];
                break;
        }
    ...
    public static function squareBranch($branchNo)
    {
        ...
        $result = [$branchNo, $second, $third, $forth];
